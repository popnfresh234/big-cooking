  ...
  render() {
    return (
      ...
      <div className="nav row">
        <div className="col-xs-12 col-md-1"><NavLink activeClassName="navlink-active" exact to="/" ><div className="nav-item">Home</div></NavLink></div>
        <div className="col-xs-12 col-md-1"><NavLink activeClassName="navlink-active" to="/recipes"><div className="nav-item">All Recipes</div></NavLink></div>
        <div className="col-xs-12 col-md-1"><NavLink activeClassName="navlink-active" to="/myrecipes"><div className="nav-item">My Recipes</div></NavLink></div>
