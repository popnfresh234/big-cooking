    ...
    return (
      <div className="content">
        <div className="nav row">
          ...
          {this.props.isLoggedIn && <div className="col-xs-12 col-md-1 nav-login"><div className="nav-item ">Logout</div></div>}
          {!this.props.isLoggedIn && <div className="col-xs-12 col-md-1 nav-login"><div className="nav-item ">Login</div></div>}
          {!this.props.isLoggedIn && <div className="col-xs-12 col-md-1 nav-login"><div className="nav-item ">Register</div></div>}
        </div>
      </div>
    );
  }
